...
class CoreAuxlistas(models.Model):
    isbn = models.CharField(max_length=13, blank=True, null=True)
    fornecedor = models.CharField(max_length=60, blank=True, null=True)
    qtde = models.IntegerField()
    pedido = models.CharField(max_length=10, blank=True, null=True)
    local = models.CharField(max_length=60, blank=True, null=True)
    lista = models.ForeignKey('CoreListas', models.DO_NOTHING)

    class Meta:
        managed = False
        db_table = 'core_auxlistas'


class CoreEmpresas(models.Model):
    num = models.IntegerField()
    empresa = models.TextField()

    class Meta:
        managed = False
        db_table = 'core_empresas'


class CoreListas(models.Model):
    data = models.DateTimeField()

    class Meta:
        managed = False
        db_table = 'core_listas'
...
class DefaultGroups(models.Model):
    user = models.ForeignKey(Default, models.DO_NOTHING)
    group = models.ForeignKey(AuthGroup, models.DO_NOTHING)

    class Meta:
        managed = False
        db_table = 'default_groups'
...
class DefaultUserPermissions(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'default_user_permissions'
